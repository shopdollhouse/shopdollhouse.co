...
const features = [
  {
    ...
    title:   "Captions, hooks, and posts — written for you in seconds.",
    sub:     "Your brand voice. Every time.",
    body:    "Our AI learns your tone, niche, and audience. Feed it a topic or photo and get scroll-stopping captions, hooks, and hashtag sets ready to publish — no staring at a blank screen ever again.",
    mockup:  "ai",
  },
  {
    eyebrow: "Auto-Scheduling",
    title:   "Post to every platform without touching your phone.",
    sub:     "Set it once. Show up daily.",
    body:    "Schedule weeks of content in one sitting. We push to Instagram, TikTok, Facebook, and Google automatically — at the exact times your audience is most active.",
    mockup:  "schedule",
  },
  {
    eyebrow: "Analytics Dashboard",
    title:   "Know exactly what's working and what's not.",
    sub:     "Real data. Real growth.",
    body:    "Track reach, saves, follows, and engagement across every platform in one clean dashboard. No spreadsheets. No guessing. Just clear insight into what to keep doing.",
    mockup:  "analytics",
  },
];
...
export default function Index() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ─── HERO ─── */}
      <CornerFrame className="min-h-[88vh] flex items-center justify-center text-center px-10 py-16">
