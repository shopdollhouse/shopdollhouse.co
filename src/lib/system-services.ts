...
export const systemServices: SystemService[] = [
  ...
  },
  {
    ...
    short: "Put your business out there online and offline with polished brand materials.",
    plain: "Printing services help your brand show up in the real world. This can be cards, flyers, menus, inserts, signs, or other printed pieces that match your online brand.",
    helps: ["Your brand looks put together.", "Customers remember you.", "Your online and offline look match.", "You have materials for events, shops, and packages."],
    steps: [
      { title: "Choose what you need", body: "Pick the printed items that fit your business." },
      { title: "We match your brand", body: "The colors, fonts, and style stay consistent." },
      { title: "You use them in real life", body: "Hand them out, place them in orders, or display them." },
    ],
    visualTitle: "Print pieces",
    visualItems: ["Card", "Flyer", "Insert", "Sign"],
    result: "Your business looks professional online and offline.",
  },
  {
