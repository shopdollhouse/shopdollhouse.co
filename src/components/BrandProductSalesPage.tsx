...
function ProductMockup({ product }: { product: BrandProduct }) {
  ...
  return (
    <figure className="relative overflow-hidden rounded-[34px] border border-white/80 bg-[rgba(255,250,246,0.72)] p-5 shadow-[0_38px_90px_-48px_rgba(90,45,35,0.65)] md:p-7">
      ...
      <div className="relative rounded-[28px] border border-[rgba(200,168,100,0.26)] bg-[rgba(255,250,246,0.76)] p-7 text-center md:p-9">
      ...
      <section className="relative overflow-hidden px-5 pb-20 pt-32 md:px-8 md:pb-28 md:pt-40">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="text-center lg:text-left">
            ...
            <h1 className="mt-7 text-[var(--rose)] leading-[0.96]" style={{ fontFamily: FONT_DISPLAY, fontSize: "clamp(3rem, 8vw, 6.7rem)", fontWeight: 400, letterSpacing: "0.035em", textTransform: "uppercase" }}>
              {product.name}
            </h1>
