...
export function AgencyFaqSection() {
  const items: [string, string][] = [
    ["What is included in the setup fee?", "Your one-time setup fee covers your full onboarding, system buildout, automation setup, CRM configuration, calendar integration, and launch prep. It is $997 for all plans, charged today to get started. Your monthly management then begins once your system is built and live."],
    ...
    ["When do I pay?", "You pay only your one-time setup fee today to get started ($997 for all plans). Your monthly billing begins once your system is live, then continues every 30 days on the same date."],
  ...
  return (
    ...
    >
      <p className="mx-auto max-w-2xl text-center" style={{ fontFamily: FONT_BODY, fontSize: "11px", lineHeight: 1.8, color: "rgba(29,15,11,0.42)" }}>
        One-time setup fee of $997 required upfront on every plan · Ad spend is not included in any package and is paid directly by you to Meta · Minimum $1,000–$2,000/mo ad spend recommended
      </p>
    </section>
  );
}
