...
const product: BrandProduct = {
  ...
  price: "$97",
  regular: "$145",
  value: "$497 value · private access arranged after payment",
  checkoutUrl: "",
  ...
  faqs: [
    ...
    { q: "How do I access it?", a: "Request access on this page and we will send the current payment and private access details." },
    ...
    { q: "Are there refunds?", a: "Due to the digital nature of this product and private access delivery, all sales are final." },
  ],
