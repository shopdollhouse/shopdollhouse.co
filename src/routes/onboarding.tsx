    ...
    <div style={pageStyle}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "60px 24px 80px" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(200,168,100,0.18)", borderRadius: 20, padding: "28px 28px", marginBottom: 40 }}>
          ...
          {[
            ["🖼️", "Your logo file", "PNG or SVG preferred"],
            ["📸", "Brand photos or images", "Of your space, team, products, or yourself"],
            ["🎨", "Your brand colours", "Hex codes if you have them — or a description (e.g. 'blush, gold, cream')"],
            ["📱", "2–3 Instagram accounts you love", "For aesthetic inspiration — any industry"],
            ["🌐", "Websites you love the feel of", "Note the URL and what you love about them"],
            ["📋", "Your top 3 services or products", "With a short description of each"],
            ["⭐", "Any existing client reviews", "Google reviews, DMs, or written testimonials you can share"],
          ].map(([icon, title, desc]) => (
            <div key={title as string} style={{ display: "flex", gap: 14, alignItems: "flex-start", marginBottom: 14 }}>
              <span style={{ fontSize: "1rem", flexShrink: 0, marginTop: 1 }}>{icon}</span>
              <div>
                <p style={{ fontFamily: FONT_LUXE, fontSize: "0.78rem", color: "var(--ink)", fontWeight: 600, marginBottom: 1 }}>{title}</p>
