  ...
  const tiers = [
    {
      ...
      cta: "Get Started →",
      features: [
        "AI clone or custom brand character — content that sounds and feels like you",
        "Custom content creation matched to your brand voice & identity",
        "Reels, carousels & static posts — 3x per week (12/mo)",
        "Comment word triggers — someone comments a keyword on your post, they're instantly sent to your landing page",
        "DM automation — reply to every inquiry automatically and guide them straight to book or buy",
    ...
    },
    {
      ...
      features: [
        ...
        "Google, Facebook, Instagram & TikTok ad management",
        "Daily content — 5–7x per week (up to 28 posts/mo)",
        "Monthly email newsletter campaign written & designed for you",
