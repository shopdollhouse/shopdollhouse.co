...
function Pricing() {
  const tiers = [
    ...
    },
    {
      ...
      price: "$2,500",
      software: "$300/mo",
      tagline: "Everything in Starter, expanded to 3 platforms — with paid ads, strategy calls, and full automation.",
      cta: "Get a Free Proposal →",
      features: [
        "3 platforms fully managed — Instagram, TikTok & Facebook (vs. 1 in Starter)",
        "Everything in Starter — AI clone, videos, graphics & full automation backend",
        "Paid Meta ads management — Facebook & Instagram ad campaigns fully managed",
        "Weekly strategy email — insights, what's working, and what we're focusing on next",
        "Monthly strategy call — a real call to review results and plan the month ahead",
        "Automated appointment reminders — text & email reminders before every booking",
        "Reputation & review management — automated review requests after every appointment",
        "Email & SMS broadcast campaigns — promotions, re-engagement & announcements",
        "Up to 20 posts/month across all 3 platforms",
      ],
    },
  ];
