...
function Pricing() {
  const tiers = [
    ...
    },
    {
      ...
      price: "$2,500",
      software: "$300/mo",
      tagline: "Everything in Starter — expanded to 3 platforms, with weekly strategy and more reach.",
      cta: "Get a Free Proposal →",
      features: [
        "3 platforms fully managed — Instagram, TikTok & Facebook (vs. 1 in Starter)",
        "Everything in Starter — AI clone, 3 videos/week, graphics, full automation backend",
        "Weekly strategy email — insights, what's working, and what we're doing next",
        "Automated appointment reminders — text & email reminders sent before every booking",
        ...
        "More content, more reach — up to 20 posts/month across all 3 platforms",
        "Monthly performance report — clear results in plain English",
      ],
    },
  ];
