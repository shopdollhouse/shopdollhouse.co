...
function Pricing() {
  const tiers = [
    ...
    },
    {
      ...
      price: "$5,000+",
      software: "$300/mo",
      tagline: "Your entire online business — content, ads, automation, and strategy all done for you.",
      featured: true,
      ...
      features: [
        ...
        "Advanced AI voice agent — answers calls, qualifies leads, books appointments 24/7",
        ...
        "Quarterly brand audit & full content refresh",
      ],
    },
    {
      name: "Growth",
      ...
      features: [
        ...
        "Reels, carousels & static posts — 5x per week (20/mo) across all 3 platforms",
        ...
        "Weekly strategy email + monthly strategy call",
