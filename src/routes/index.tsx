  ...
  const tiers = [
    ...
    },
    {
      ...
      features: [
        ...
        "Daily content — 28 posts/month (4 Reels · 4 Carousels · 4 Static per platform), all on-brand",
        "Content approval before posting — you see and approve everything before it goes live",
        ...
        "AI website design & build — a complete conversion-ready site built in month 1",
